...
For the complete identifier-to-annotation-to-structure route, start from **Toolkits → Protein Links**. The current Swiss-Model interface screenshot is documented there because it represents the structure follow-up step after a protein has been resolved.
...
::: {.callout-important}
Treat the Swiss-Model API token as a credential. Do not publish it in screenshots, manuscripts, repositories or shared project files.
:::
